...
import { fileIdP, fileIdT, posTag, trTag, positionId, findTag, numericPart } from './graph.grouping';
...
export function sortBands(
    ...
    const proj = orderType === 'num' ? (v: unknown) => numericPart(v) ?? Number.POSITIVE_INFINITY : undefined;
